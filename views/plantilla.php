                ...
                <div class="pad10A">
                    ...
                    <ul class="chat-box">
                        <li>
                            <div class="status-badge">
                                <img class="img-circle" width="40"
                                    src="../assets/image-resources/people/testimonial1.jpg" alt="">
                        ...
                        <li>
                            <div class="status-badge">
                                <img class="img-circle" width="40"
                                    src="../assets/image-resources/people/testimonial2.jpg" alt="">
                                <div class="small-badge bg-green"></div>
                            </div>
                            <b>
                                Carl Gamble
                        ...
                        <li>
                            <div class="status-badge">
                                <img class="img-circle" width="40"
                                    src="../assets/image-resources/people/testimonial3.jpg" alt="">
                                <div class="small-badge bg-green"></div>
                            </div>
                            <b>
                                Michael Poole
                        ...
                        <li>
                            <div class="status-badge">
                                <img class="img-circle" width="40"
                                    src="../assets/image-resources/people/testimonial4.jpg" alt="">
                                <div class="small-badge bg-green"></div>
                            </div>
                            <b>
                                Bill Green
                        ...
                        <li>
                            <div class="status-badge">
                                <img class="img-circle" width="40"
                                    src="../assets/image-resources/people/testimonial5.jpg" alt="">
                                <div class="small-badge bg-green"></div>
                            </div>
                            <b>
                                Cheryl Soucy
                    ...
                    <ul class="chat-box">
                        <li>
                            <div class="status-badge">
                                <img class="img-circle" width="40"
                                    src="../assets/image-resources/people/testimonial6.jpg" alt="">
                        ...
                        <li>
                            <div class="status-badge">
                                <img class="img-circle" width="40"
                                    src="../assets/image-resources/people/testimonial7.jpg" alt="">
                                <div class="small-badge bg-orange"></div>
                            </div>
                            <b>
                                Dan Garcia
                        ...
                        <li>
                            <div class="status-badge">
                                <img class="img-circle" width="40"
                                    src="../assets/image-resources/people/testimonial8.jpg" alt="">
                                <div class="small-badge bg-orange"></div>
                            </div>
                            <b>
                                Edward Bridges
        ...
        <div id="page-wrapper">
            <div id="page-header" class="bg-gradient-9">
                <div id="mobile-navigation">
                    ...
                    <a href="dashboard.php" class="logo-content-small" title="MonarchUI"></a>
                </div>
                <div id="header-logo" class="logo-bg">
                    <a href="dashboard.php" class="logo-content-big" title="MonarchUI">
                        Monarch <i>UI</i>
                        <span>The perfect solution for user interfaces</span>
                    </a>
                    <a href="views/dashboard.php" class="logo-content-small" title="MonarchUI">
                        Monarch <i>UI</i>
                        <span>The perfect solution for user interfaces</span>
                    </a>
                        ...
                        <div class="dropdown-menu float-left">
                            <div class="box-sm">
                                ...
                                <div class="pad5A button-pane button-pane-alt text-center">
                                    <a href="logout.php" class="btn display-block font-normal btn-danger">
                    ...
                    <ul id="sidebar-menu">
                        ...
                        <li>
                            ...
                            <div class="sidebar-submenu">
                                ...
                                <ul>
                                    <li><a href="busqueda.php" title="Búsqueda"><span>Búsqueda</span></a></li>
                                    <li><a href="indexacion.php"
                                            title="Labels &amp; Badges"><span>Indexación</span></a>
                                    </li>
                                    <li><a href="configuracion.php"
                                            title="Content boxes"><span>Configuración</span></a>
                                    </li>
                                </ul>
                            </div><!-- .sidebar-submenu -->
                        </li>
            ...
            <div id="page-content-wrapper">
                <div id="page-content">
                    ...
                    <div class="container">
                        ...
                        <script type="text/javascript" src="../assets/widgets/charts/sparklines/sparklines.js">
                        </script>
                        <script type="text/javascript" src="../assets/widgets/charts/sparklines/sparklines-demo.js">
                        </script>
                        ...
                        <script type="text/javascript" src="../assets/widgets/charts/piegage/piegage-demo.js">
                        </script>
                            ...
                            <div id="theme-options" class="admin-options">
                                ...
                                <div id="theme-switcher-wrapper">
                                    <div class="scroll-switcher">
                                        ...
                                        <ul class="reset-ul">
                                            <li>
                                                <a href="agencias.php" title="Agencias"><span>Agencias</span></a>
                                            </li>
                                            <li>
                                                <a href="grupos.php" title="Grupos"><span>Grupos</span></a>
                                            </li>
                                            <li>
                                                <a href="documentos.php" title="Documentos"><span>Documentos</span></a>
                                            </li>
                                            <li>
                                        ...
                                        <div class="theme-color-wrapper clearfix">
                                            ...
                                            <a class="tooltip-button set-adminheader-style bg-green"
                                                ...
                                                href="javascript:void(0);">Green</a>
                                ...
                                <div class="content-box">
                                    <h3 class="content-box-header bg-default">
                                        ...
                                        <span class="header-buttons-separator">
                                            ...
                                            <a href="#" class="icon-separator refresh-button" data-style="dark"
                                                data-theme="bg-white" data-opacity="40">
                                                <i class="glyph-icon icon-refresh"></i>
                                            </a>
